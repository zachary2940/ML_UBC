...
def create_user_item_matrix(ratings,user_key="user",item_key="item"):
    ...
    user_ind = [user_mapper[i] for i in ratings[user_key]] #returns unique value in the list for that user id
    item_ind = [item_mapper[i] for i in ratings[item_key]]#returns unique value in the list for that item id
